    ...
    <Card className={cn('gap-4', className)}>
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='flex items-center justify-between gap-1'>
          ...
          <ChartContainer config={productReachChartConfig} className='min-h-[52px] max-w-[72px]'>
        ...
        <div className='flex items-center justify-between gap-1'>
          ...
          <ChartContainer config={orderPlacedChartConfig} className='min-h-[52px] max-w-[72px]'>
